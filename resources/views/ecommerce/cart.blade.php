            ...
            <div class="row mt-2" style="background: white;">
                <div class="col p-2">
                    <div class="form-check">
                        <input type="checkbox" id="allProduct" class="form-control-check all" @click="checkAll">
                ...
                @foreach ($cartProducts as $key => $innerArray)
                    <div class="row mt-2" style="background: white;">
                        ...
                        <div class="col p-2 d-flex flex-column">
                            <div class="pt-2 px-0">
                                <div class="form-check">
                                    <input type="checkbox" class="form-control-check shop-{{ $shop->id }} all" @click="check({{ $shop->id }})">
