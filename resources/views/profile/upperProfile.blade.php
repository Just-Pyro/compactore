...
<div class="row">
    <div class="col-3 p-2">
        <div class="rounded bg-white p-3">
            ...
            <p class="fw-medium m-0 text-center">{{ $profile->username }}</p>
        ...
        <div class="rounded bg-white p-3 position-relative">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <hr>
                    <textarea placeholder="write something ..." cols="30" rows="5" class="form-control bg-dark-subtle mt-2" :disabled="!editMode">{{ $profile->bio }}</textarea>
                </div>
                <div class="col">
